                ...
                @foreach ($projects as $project)
                    <div class="col-lg-4 col-md-6 portfolio-item first">
                        <div class="portfolio-img rounded overflow-hidden">
                            <img class="img-fluid" src="{{ asset('storage/' . $project->images->first()->image_path) }}" alt="">
                            <div class="portfolio-btn">
                                <a class="btn btn-lg-square btn-outline-light rounded-circle mx-1"
                                    href="{{ asset('storage/' . $project->images->first()->image_path) }}" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square btn-outline-light rounded-circle mx-1"
                                    href="{{ route('portfolio.show', $project->id) }}"><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                        <div class="pt-3">
