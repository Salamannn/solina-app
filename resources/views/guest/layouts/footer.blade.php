    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-3">
                ...
                <p class="text-white mb-2">Today : {{ $visitorsToday }}</p>
                <p class="text-white mb-2">Yesterday : {{ $visitorsYesterday }}</p>
            ...
            <div class="col-lg-3 col-md-3">
                ...
                <a class="btn btn-link" href="">Company Legality</a>
            </div>
